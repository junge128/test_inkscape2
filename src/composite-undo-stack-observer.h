...
public:
	...
	public:
		...
		void issueUndoCommit(Event* log)
		{
			this->_observer->notifyUndoCommitEvent(log);
                ...
                /**
                 * Issue an undo expiration event to the UndoStackObserver
                 */
                void issueUndoExpired(Event *log)
                {
                    this->_observer->notifyUndoExpired(log);
                }
	...
	void notifyRedoEvent(Event* log) override;
        ...
        /**
         * Notify all registered UndoStackObservers of an event log being expired from the back of the undo stack.
        *
        * \param log The event log being committed to the undo stack.
        */
